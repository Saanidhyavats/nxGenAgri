...
def home():
    ...
    return render_template('index1_1_1.html', title=title)
...
def crop_recommend():
    ...
    return render_template('./templates/crop.html', title=title)
...
def disease_prediction():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('page-1_1.html', prediction=prediction, title=title)
